...
delElem(id){
  ...
  <div className="">
  <i data-edit={item.id} onClick={this.editLink}><Icon type="edit" className="edit-button"/></i>
    <i className="material-icons delete-button" data-elem ="link" data-del={item.linkID} onClick={this.delElem}>delete</i>  </div>
</li>)}
    </ul>
}
editLink(){
