...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 03 2018 г., 23:33
...
INSERT INTO `linkTables` (`id`, `tableName`, `width`, `height`, `x`, `y`) VALUES
(1, 'sport', 200, 200, 300, 300),
(2, 'school', 300, 300, 200, 200),
(3, 'job', 400, 500, 100, 100),
(5, 'job', 400, 500, 100, 100),
(6, 'job', 400, 500, 100, 100),
(7, 'job', 400, 500, 100, 100),
(8, 'hobby', 50, 50, 120, 130);
